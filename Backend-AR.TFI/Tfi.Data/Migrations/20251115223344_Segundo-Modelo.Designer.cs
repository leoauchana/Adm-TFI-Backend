...
namespace Tfi.Data.Migrations
{
    ...
    [Migration("20251115223344_Segundo-Modelo")]
    partial class SegundoModelo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChangeHistoryFunction", b =>
                {
                    b.Property<int>("ChangesHistoryId")
                        .HasColumnType("int");

                    b.Property<int>("FunctionsId")
                        .HasColumnType("int");

                    b.HasKey("ChangesHistoryId", "FunctionsId");

                    b.HasIndex("FunctionsId");

                    b.ToTable("ChangeHistoryFunction");
                });
            ...
            modelBuilder.Entity("ChangeHistoryFunction", b =>
                {
                    b.HasOne("Tfi.Domain.Entities.ChangeHistory", null)
                        .WithMany()
                        .HasForeignKey("ChangesHistoryId")
