...
namespace Tfi.Domain.Repository;
...
public interface IRepository
{
    ...
    Task<TEntity?> ObtenerPorId<TEntity>(int id, params string[] incluidos) where TEntity : EntityBase;
    Task<TEntity> ObtenerPorIdCon<TEntity>(int id, params Expression<Func<TEntity, object>>[] includes) where TEntity : EntityBase;
