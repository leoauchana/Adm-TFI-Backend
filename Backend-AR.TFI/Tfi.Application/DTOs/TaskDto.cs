...
{
    public record Request(int idFunction, string taskName, string taskDescription, Priority taskPriority, DateTime dateEnd, List<ResourceDto.Request> resourceList);
